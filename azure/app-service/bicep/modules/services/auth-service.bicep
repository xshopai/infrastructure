  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        // JWT Keys - auth-service is the issuer
        { name: 'JWT_PRIVATE_KEY', value: '@Microsoft.KeyVault(SecretUri=https://${keyVaultName}.vault.azure.net/secrets/jwt-private-key/)' }
        ...
        { name: 'TOKEN_REFRESH_THRESHOLD', value: '300' }
      ]
    }
  }
}
    ...
    accessPolicies: [
      {
        ...
        objectId: authService.identity.principalId
        permissions: {
          secrets: ['get', 'list']
        }
      }
...
output appServiceName string = authService.name
output appServiceUrl string = 'https://${authService.properties.defaultHostName}'
output principalId string = authService.identity.principalId
